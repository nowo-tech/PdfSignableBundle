        ...
        return [
            ...
            [
                ...
                'items' => [
                    ...
                    ['type' => 'cards', 'col_class' => 'col-md-6 col-lg-4', 'cards' => [
                        ['title' => 'Draw signature in box', 'bullets' => ['<code>enable_signature_capture: true</code> — draw pad (canvas) per box', 'Draw with mouse or finger; image shown in overlay', 'Low legal validity (acceptance/consent)'], 'route' => 'app_signing_draw', 'btn_class' => 'btn-success', 'card_class' => 'border-success'],
                        ['title' => 'Draw or upload signature image', 'bullets' => ['Draw pad + file upload per box', 'Same storage; image in overlay'], 'route' => 'app_signing_upload', 'btn_class' => 'btn-primary'],
                        ['title' => 'Legal disclaimer', 'bullets' => ['<code>signing_legal_disclaimer</code> + optional URL', 'Inform users about legal effect of signing method'], 'route' => 'app_signing_legal_disclaimer', 'btn_class' => 'btn-primary'],
