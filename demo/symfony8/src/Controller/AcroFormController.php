...
class AcroFormController extends AbstractController
{
    ...
    {
        $explanation = '<ul class="mb-0"><li><strong>URL field visible</strong> — config <code>with_url</code> with <code>url_field: true</code>. The PDF URL input row is shown (compare with default config which has <code>url_field: false</code>).</li></ul>';
    ...
    {
        $explanation = '<ul class="mb-0"><li><strong>Field names as associative array</strong> — config <code>field_names_map</code> with <code>field_name_choices</code> as a map (label => value). In YAML: <code>Nombre: nombre</code>, <code>Apellidos: apellidos</code>, etc. The key is the dropdown label; the value is the PDF field name (/T).</li></ul>';
    ...
    {
        $explanation = '<ul class="mb-0"><li><strong>Field names as value|Label list</strong> — config <code>field_names_pipe</code> with <code>field_name_choices: [\'nombre|Nombre\', \'apellidos|Apellidos\', ...]</code>. Each entry is <code>value|Label</code> for the dropdown.</li></ul>';
