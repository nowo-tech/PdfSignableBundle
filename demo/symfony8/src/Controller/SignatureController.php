 ...
 *
 * Routes: /demo-signature, /demo-signature/fixed-url, /demo-signature/url-choice,
 * /demo-signature/limited-boxes, /demo-signature/predefined
 */
class SignatureController extends AbstractController
{
    ...
    public function predefinedBoxes(Request $request): Response
    {
        ...
        if (!$request->isMethod('POST')) {
            // GET: pre-fill URL and two boxes for the demo
