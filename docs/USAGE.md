...
- [Form type that renders the view](#form-type-that-renders-the-view)
- [Demo page](#demo-page)
- [Viewer interaction](#viewer-interaction)
- [Using the form type in your application](#using-the-form-type-in-your-application)
  - [Recovering coordinates and signature data on POST](#recovering-coordinates-and-signature-data-on-post)
...
- [Customization options](#customization-options)
  ...
  - [Unit](#unit)
  - [Origin](#origin)
  - [Signature boxes (collection)](#signature-boxes-collection)
  - [Signing in boxes (draw or image)](#signing-in-boxes-draw-or-image)
  - [Legal disclaimer](#legal-disclaimer)
  - [Making the signature more legally robust](#making-the-signature-more-legally-robust)
  - [Same signer (machine name), multiple locations](#same-signer-machine-name-multiple-locations)
  - [SignatureBoxType (each box): name field](#signatureboxtype-each-box-name-field)
  - [Example: fixed URL and restricted units](#example-fixed-url-and-restricted-units)
  - [Example: URL as dropdown](#example-url-as-dropdown)
  - [Example: free-text unit and origin (validated)](#example-free-text-unit-and-origin-validated)
  - [Example: page restriction (allowed pages)](#example-page-restriction-allowed-pages)
  - [Example: sorted boxes on submit](#example-sorted-boxes-on-submit)
  - [Example: minimum signature box size](#example-minimum-signature-box-size)
  - [Example: no overlapping boxes](#example-no-overlapping-boxes)
  - [Export / import coordinates](#export-import-coordinates)
  - [Example: default values per box name](#example-default-values-per-box-name)
  - [Example: custom constraints](#example-custom-constraints)
  - [Example: limited boxes and name as selector](#example-limited-boxes-and-name-as-selector)
  - [Example: predefined boxes (from model)](#example-predefined-boxes-from-model)
- [Overriding bundle templates](#overriding-bundle-templates)
  - [Bundle template paths](#bundle-template-paths)
  - [Data attributes (required when overriding)](#data-attributes-required-when-overriding)
  - [Overriding the form theme](#overriding-the-form-theme)
  - [Overriding the signature index view](#overriding-the-signature-index-view)
  - [Translations](#translations)
- [Reusable SignatureBoxType layout](#reusable-signatureboxtype-layout)
  - [Default usage](#default-usage)
  - [Reusing the fragment](#reusing-the-fragment)
  - [Overriding the layout](#overriding-the-layout)
- [Form submit behavior](#form-submit-behavior)
- [PDF proxy](#pdf-proxy)
