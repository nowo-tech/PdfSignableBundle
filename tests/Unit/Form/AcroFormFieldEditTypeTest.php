...
final class AcroFormFieldEditTypeTest extends TypeTestCase
{
    ...
    public function testBuildFormWithFieldNameModeChoiceAndEmptyOtherTextOmitsFieldNameOther(): void
    {
        $form = $this->factory->create(AcroFormFieldEditType::class, new AcroFormFieldEdit(), [
            'field_name_mode'       => 'choice',
            'field_name_choices'    => ['Option A' => 'a'],
    ...
    public function testBuildFormWithFieldNameChoicesAsListOfMaps(): void
    {
        $form = $this->factory->create(AcroFormFieldEditType::class, new AcroFormFieldEdit(), [
            'field_name_mode'    => 'choice',
            'field_name_choices' => [
    ...
    public function testBuildFormWithEmptyFontFamiliesUsesDefaultChoices(): void
    {
        $form = $this->factory->create(AcroFormFieldEditType::class, new AcroFormFieldEdit(), [
            'font_families' => [],
        ]);
