...
final class SignatureCoordinatesTypeTest extends TypeTestCase
{
    ...
    public function testSortBoxesUsesXComparisonWhenPageAndYAreEqual(): void
    {
        $model = new SignatureCoordinatesModel();
        $model->setPdfUrl('https://example.com/doc.pdf');
        $form = $this->factory->create(SignatureCoordinatesType::class, $model, [
        ...
        $form->submit([
            ...
            'origin'         => SignatureCoordinatesModel::ORIGIN_BOTTOM_LEFT,
            'signatureBoxes' => [
                0 => ['name' => 'b', 'page' => 1, 'width' => 20.0, 'height' => 40.0, 'x' => 50.0, 'y' => 100.0],
                1 => ['name' => 'a', 'page' => 1, 'width' => 20.0, 'height' => 40.0, 'x' => 10.0, 'y' => 100.0],
            ],
        ]);
        self::assertTrue($form->isSynchronized());
        self::assertTrue($form->isValid());
    ...
    public function testBuildViewShowLoadPdfButtonDefaultTrueWithoutModelPdfUrl(): void
    {
        $form = $this->factory->create(SignatureCoordinatesType::class, new SignatureCoordinatesModel());
        $view = $form->createView();
        self::assertTrue($view->vars['signature_coordinates_options']['show_load_pdf_button']);
    }
}
